    ...
    <section className="w-full max-w-6xl mx-auto flex flex-col  gap-8 md:gap-12 py-12 p">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow p-6 min-h-[180px]">
            ...
            <span className="block mt-2 text-xs text-gray-500">
              This mission reflects my commitment to being a nurse who leads
              with empathy, professionalism, and purpose—someone who listens,
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow p-6 min-h-[180px]">
            ...
            <span className="block mt-2 text-xs text-gray-500">
              My long-term vision is to influence not only the care I provide
              but also the healthcare environment around me, encouraging
      ...
      <div className="bg-white rounded-xl shadow mx-6 p-6 mt-4">
        ...
        <p className="text-gray-600 text-base">
          ...
          guide every academic decision, clinical action, and reflective moment
          shared throughout this portfolio.”
        </p>
      </div>
    </section>
  );
